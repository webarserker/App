        ...
        <div class="home-container">
            ...
            <div class="guide_container">
                ...
                <div class="swiper-container guide-swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide" v-for="(x,idx) of baokao"
                             @click="$router.push('/articleList?catId='+x.id)">
            ...
            <div class="notice_container" >
                <h2 class="title_carousel" @click="$router.push('/noticeList?name=招录公告')">
                    <b :style={background:$store.state.themeColor}></b>
                    <span>招录公告</span>
                    <i class="more"></i>
                    <s>more</s>
                ...
                <div class="notice_items">
                    <div class="notice_item" v-for="obj of noticeList"
                         @click="goToDetail(obj.contentLink,obj.infoId,obj.catId)">
                        <div class="datetime">
                            <span v-text="getMonthAndDay(obj.date)"></span>
                            <span v-text="getYear(obj.date)"></span>
                        </div>
                        <p v-text="obj.title"></p>
                        <span v-if="isRead(obj)" class="comicon-08 unread"></span>
                    </div>
                </div>
            </div>
            <!-- 智能在线答疑模块 -->
            ...
            <div class="hot_container" >
                ...
                <div class="news_items">
                    <div class="news_item" v-for="obj of newsList"
                         @click="goToDetail(obj.contentLink,obj.infoId,newsCatId)">
...
//            })
    ...
    /*********************************************************************************/
            ...
            /*******************************快讯接口*******************************/
//            this.$http.get(state.host+'/front/template/'+state.scode+'/'+state.mVersion+'/News').then(res=>{
//                res=res.body;
//                console.log(res);
//                if(res.data==null){
//                    this.newsList=[]
//                }else{
//                    this.newsList=res.data[0].children.slice(0,3);
...
//                    this.noticeList=[]
//                }else{
//                    this.noticeList=res.data[0].children.slice(0,3);
//                }
//            })
