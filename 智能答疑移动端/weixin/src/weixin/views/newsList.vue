    ...
    export default {
        ...
        methods: {
            ...
            getDate: function () {
                ...
                this.ajaxFlag = true
                var state = this.$store.state
                this.$http.get(state.host + state.baseUrl + '/index/hotList?sCode=' + state.scode + '&curPage=' + this.curPage + '&pageSize=20')
                    .then(res => {
                ...
                .then(res => {
                    ...
                    wx.ready(function () {
                        wx.onMenuShareTimeline({
                            ...
                            imgUrl: state.imgHost + state.allSchoolInfo.iconUrl, // 分享图标
                            success: function () {
                                // 用户确认分享后执行的回调函数
                            },
                            cancel: function () {
