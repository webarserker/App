...
exports.default = {
    ...
    components: {
        ...
        "v-comp-0": __webpack_require__(291),
        "v-comp-research-detail": __webpack_require__(294),
        "v-menuball": __webpack_require__(15),
        "v-sdecode": __webpack_require__(17),
        "v-sdecode2": __webpack_require__(18),

        /*****************新注册一个院系详情页组件************************/
        "v-comp-school-detail": __webpack_require__(295)
        /*****************************************/
    ...
    methods: {
        getViewTimes: function getViewTimes(viewTimes) {
        ...
        //            },
        /********************************************************************/
        changeSpecType: function changeSpecType(specType) {
    ...
    mounted: function mounted() {
        ...
        this.$http.get(state.host + state.baseUrl + '/infoContent/getInfoContentDetail?infoId=' + this.infoId + userId + '&sCode=' + state.scode + '&parentId=' + this.catId).then(function (res) {
            ...
            console.log(_this2.title, _this2.specType);
    ...
    created: function created() {
        ...
        this.$http.get(state.host + state.baseUrl + '/index/getBaseInfo?sCode=' + state.scode + userId + login).then(function (res) {
            ...
            document.title = data.school.name + '-' + (_this3.tid ? '专业详情' : _this3.sId ? '院系详情' : '文章详情');
...
//# sourceMappingURL=0.44d747e3dfd291c315e0.hot-update.js.map