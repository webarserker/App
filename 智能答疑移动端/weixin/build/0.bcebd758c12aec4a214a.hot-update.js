...
exports.default = {
    ...
    created: function created() {
        ...
        this.$http.get(this.$store.state.host + '/front/template/getParentInfoCat?catId=' + catId).then(function (res) {
            res = res.body;
            console.log(res);
        });
...
//# sourceMappingURL=0.bcebd758c12aec4a214a.hot-update.js.map