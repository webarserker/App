...
exports.default = {
    ...
    watch: {
        ...
        catId: function catId() {
            ...
            this.$http.get(this.$store.state.host + '/front/template/getParentInfoCat?catId=' + this.catId).then(function (topRes) {
                topRes = topRes.body;
                if (topRes.data != _this4.catId) {
                    sessionStorage.setItem('replace3catId', _this4.catId);
                    _this4.$router.push('/articleList?catId=' + topRes.data);
                }

                //                this.getInit()
                var state = _this4.$store.state;
                _this4.$http.get(state.host + state.baseUrl + '/infoCat/getInfoCatlist?sCode=' + state.scode + '&catId=' + _this4.catId).then(function (res) {
                    ...
                    if (_this4.$children[0].$refs.sub_navs_swiper_wrap) {
                        ...
                        for (var z = 0; z < theChildren.length; z++) {
                            if (theChildren[z].catId == sessionStorage.replace3catId) {
                                _this4.$children[0].tapIndex = z;
                                _this4.tapIndex = z;

                                articleListCatId = theChildren[z].catId;
                                _this4.articleListCatId = theChildren[z].catId;
                            }
                        }
                        /*********************************************************************************************/

                        alert(articleListCatId);
    ...
    created: function created() {
        ...
        this.$http.get(this.$store.state.host + '/front/template/getParentInfoCat?catId=' + this.catId).then(function (res) {
            res = res.body;
            if (res.data != _this5.catId) {
                sessionStorage.setItem('replace3catId', _this5.catId);
                _this5.$router.push('/articleList?catId=' + res.data);
            }

            _this5.$store.commit('CHANGE_LOADINGFLAG', true);
            //            this.getInit()


            var state = _this5.$store.state;
            _this5.$http.get(state.host + state.baseUrl + '/infoCat/getInfoCatlist?sCode=' + state.scode + '&catId=' + _this5.catId).then(function (res) {
...
//# sourceMappingURL=0.d6e96ee7127ab67cf424.hot-update.js.map