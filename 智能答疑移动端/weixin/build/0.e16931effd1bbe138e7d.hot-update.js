...
exports.default = {
    beforeRouteEnter: function beforeRouteEnter(to, from, next) {
        next(function (vm) {
            if (from.path.indexOf('articleDetail') > -1) {
                ...
                vm.mySubConData2 = JSON.parse(sessionStorage.getItem('subConData2'));
                alert(sessionStorage.getItem('subConData2'));
                //                    alert(vm.tapIndex);
            } else {
    ...
    components: {
        "v-subNav": __webpack_require__(288)
    },
    methods: _extends({
...
//# sourceMappingURL=0.e16931effd1bbe138e7d.hot-update.js.map