...
exports.default = {
    created: function created() {
        ...
        if (!user) {
            ...
            alert('登陆了');
            _this.$http.get(_this.$store.state.host + '/weixin/api/user/getUserIsSub?id=' + user.id).then(function (res) {
                res = res.body;
                console.log(res);
            });
        }
...
//# sourceMappingURL=0.849f15be8a1240b90a00.hot-update.js.map