                ...
                if(data){
                    if(data.data && data.data.length > 0){
                        ...
                        for(var key in majorList){
                            ...
                            _html += '<td><a href="javascript:majorInfo.toMajorDetail(\''+ major.id +'\');">'+ (major.name == null?'':major.name) +'</a></td>';
