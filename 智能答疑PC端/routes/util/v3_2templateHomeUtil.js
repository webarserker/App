...
var v3_2templateHomeUtil={};
v3_2templateHomeUtil.getInfoContentDetail = function(infoId,parentId,sCode,callback){
    var url = API_BASE_URL + '/weixin/api/infoContent/getInfoContentDetail?'
        + 'infoId='+infoId
        + '&sCode='+sCode
        + '&parentId='+parentId;
    console.log("v3_2templateHomeUtil.getInfoContentDetail: " + url);
    superagent.get(url)
...
module.exports = v3_2templateHomeUtil;