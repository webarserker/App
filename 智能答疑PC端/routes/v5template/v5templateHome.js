...
function getHomePage(req,res,next){
    ...
    v5templateHomeUtil.findSchool(codeOrIdentify, function(findSchoolErr, schoolInfo){
        ...
        // 2. 获取学校轮播图信息
        v5templateHomeUtil.getBanners(schoolInfo.code, function(getBannerErr, bannerInfo){
            if(getBannerErr) {
                console.log("v5templateHome.js [getHomePage] getBannerErr: " + findSchoolErr);
                var errMsg = "请求失败";
                errMsg = typeof findSchoolErr == 'string' ? findSchoolErr : errMsg;
                return v5templateHomeUtil.ret_json_func(0,errMsg,{},res);
            }
            // 3. 获取友情链接信息
            v5templateHomeUtil.getSchoolFriendLinks(schoolInfo.code, function(getFriendLink, linkInfo){
                if(getFriendLink) {
                    console.log("v5templateHome.js [getHomePage] getBannerErr: " + findSchoolErr);
                    var errMsg = "请求失败";
                    errMsg = typeof findSchoolErr == 'string' ? findSchoolErr : errMsg;
                ...
                async.series([
                    function(callback){
                        v5templateHomeUtil.getMainPageModuleInfo(schoolInfo.code, schoolInfo.template, "m01", function(err,data){return callback(err,data)});
                    },//**** m01 模板头部
                    function(callback){
                        v5templateHomeUtil.getMainPageModuleInfo(schoolInfo.code, schoolInfo.template, "m02", function(err,data){return callback(err,data)});
                    },//**** m02 导航栏,
                    function(callback){
                        v5templateHomeUtil.getMainPageModuleInfo(schoolInfo.code, schoolInfo.template, "m04", function(err,data){return callback(err,data)});
                    },//**** m04 快捷入口
                    function(callback){
                        v5templateHomeUtil.getMainPageModuleInfo(schoolInfo.code, schoolInfo.template, "m05", function(err,data){return callback(err,data)});
                    },//**** m05 左分类文章
                    function(callback){
                        v5templateHomeUtil.getMainPageModuleInfo(schoolInfo.code, schoolInfo.template, "m06", function(err,data){return callback(err,data)});
                    },//**** m06 右分类文章
                    function(callback){
                        v5templateHomeUtil.getMainPageModuleInfo(schoolInfo.code, schoolInfo.template, "m07", function(err,data){return callback(err,data)});
                    },//**** m07 左分类文章
                    function(callback){
                        v5templateHomeUtil.getMainPageModuleInfo(schoolInfo.code, schoolInfo.template, "m08", function(err,data){return callback(err,data)});
                    },//**** m08 单个标题跳转
                    function(callback){
                        v5templateHomeUtil.getMainPageModuleInfo(schoolInfo.code, schoolInfo.template, "m09", function(err,data){return callback(err,data)});
                    },//**** m09 导师风采
                    function(callback){
                        v5templateHomeUtil.getMainPageModuleInfo(schoolInfo.code, schoolInfo.template, "m10", function(err,data){return callback(err,data)});
                    },//**** m10 研招动态
                    function(callback){
                        v5templateHomeUtil.getInfoCatByFAQ(schoolInfo.code,function(err,data){return callback(err,data)});
                    },//***** 首页增加常见问题,返回父级id 字段
                    function(callback){
                        v5templateHomeUtil.findContactWay(schoolInfo.code,function(err,data){return callback(err,data)});
                    } // 页尾 联系方式
                    ...
                    retJson.banner = bannerInfo;
                    retJson.friendLink = linkInfo;
                    retJson.m01 = modules[0];
                    retJson.m02 = modules[1];
                    retJson.m04 = modules[2];
                    retJson.m05 = modules[3];
                    retJson.m06 = modules[4];
                    retJson.m07 = modules[5];
                    retJson.m08 = modules[6];
                    retJson.m09 = modules[7];
                    retJson.m10 = modules[8];
                    retJson.question = modules[9];
                    retJson.contact = modules[10];
                    // 尝试获取用户登录信息
                    ...
                    if(userInfoJson && userInfoJson.length > 2) {
                        ...
                        v5templateHomeUtil.getNoticeNum(schoolInfo.code, userToken,function(getNoticeNumErr, NoticeNumInfo) {
                            if (getNoticeNumErr) {
                            ...
                            return res.render('./v5template/pages/01_v5templateHome',retJson);
                        });
...
router.get('/v5templateHomePage',getHomePage);
router.post('/v5templateHomePage',getHomePage);
...
function getDetailPage(req,res,next){
    ...
    v5templateHomeUtil.findSchool(sCode, function(findSchoolErr, schoolInfo){
        ...
        v5templateHomeUtil.getInfoContentDetail(infoId,parentId,sCode,function(err,contentDetail){

            if(err) {
                console.log('v5template/v5templateHome.js [getDetailPage] getInfoContentDetail Err: ' + err);
                return v5templateHomeUtil.ret_json_func(0,'失败',{}, res);
            }
            /*
            ...
            tasks.push(function(callback){
                v5templateHomeUtil.getInfoCatlist(sCode,parentId,function(err,data){callback(err,data)})
            });
            // layout 需要使用 m01 *** 1
            tasks.push(function(callback){
                v5templateHomeUtil.getMainPageModuleInfo(schoolInfo.code, schoolInfo.template, "m01", function(err,data){return callback(err,data)});
            ...
            tasks.push(function(callback){
                v5templateHomeUtil.getSecondPageBarMenu(schoolInfo.code, function(err,data){return callback(err,data)});
            });
            ...
            tasks.push(function(callback){
                v5templateHomeUtil.getSchoolFriendLinks(schoolInfo.code,function(err,data){return callback(err,data)});
            });
            tasks.push(function(callback){
                v5templateHomeUtil.findContactWay(schoolInfo.code,function(err,data){return callback(err,data)});
                    // 页尾 联系方式
            ...
            if(contentDetail.specType == 0){
                ...
                tasks.push(function(callback){ //**** 5
                    v5templateHomeUtil.getSchoolInfoByCode(sCode,function(err,data){callback(err,data)});
                });
            }else if(contentDetail.specType == 6){
                // 加入3.3 接口请求  请求专业查询列表
                tasks.push(function(callback){
                    v5templateHomeUtil.getMajorList(sCode,false,function(err,data){callback(err,data)});
                }); // **** 5
                // 加入3.4 接口请求  请求专业详情等展示配置
                tasks.push(function(callback){
                    v5templateHomeUtil.getMajorConf(sCode,function(err,data){callback(err,data)});
                }); // **** 6
                ...
                // 请求院系列表
                tasks.push(function(callback){
                    v5templateHomeUtil.getFrontDepList(sCode,false,function(err,data){callback(err,data)});
                }); // **** 5
            ...
            async.parallel(tasks,function(error, results){
                ...
                retJson.m01 = results[1];           // 串行任务第1个.固定为m01头部信息请求
                retJson.SPBMenu = results[2];           // 串行任务第2个.固定为m02导航栏信息请求
                retJson.question = results[3];      // 串行任务第3个.固定为question 首页搜索框常见问题信息请求
                retJson.friendLink = results[4];    // 串行任务第4个.固定为friendLink页尾友情链接请求
                retJson.contact = results[5];       // 串行任务第5个.固定为contact 页尾联系方式请求
                // 尝试获取用户登录信息
                var userInfoJson = req.cookies.zndyKey;
                if(userInfoJson && userInfoJson.length > 2) {
                    var userInfo = JSON.parse(userInfoJson || '{}');
                ...
                if(contentDetail.specType == 0) {
                    ...
                    //// 05--专业查询列表
                    var professionalList = results[6];           //  专业查询列表
                    var professionalDetailShow = results[7];     //  专业详情展示配置
                ...
                retJson.host = "http://"+req.hostname;
                return res.render('./v5template/pages/02_v5templateDetail', retJson);
            });
        });
    });
}
...
function commonProblemPage(req,res,next){
    ...
    superagent.get(url)
        .end(function (err, res2) {
            ...
            problem.host = "http://"+req.hostname;
            problem.data= retJson;
            res.render('./v5template/pages/03_commonProblem',problem);
        });
}
        ...
        .end(function (err, res2) {
            ...
            superagent.get(url)
                .end(function (err, res2) {
                    ...
                    retJson.host = "http://"+req.hostname;
                    res.render('./v5template/pages/05_professionalList',retJson);
...
function v5templateSubList01(req,res,next){
    ...
    v5templateHomeUtil.findSchool(sCode, function(findSchoolErr, schoolInfo){
        ...
        async.series([
            function(callback) {
                // 获取二级分类信息 **** 0
                v5templateHomeUtil.getInfoCatlist(sCode,catId,function(err,data){callback(err,data)});
            },
            function(callback) {
                // 获取列表 **** 1
                v5templateHomeUtil.getInfoContentlist(sCode,catId,curPage,pageSize,function(err,data){callback(err,data)});
            },
            function(callback){
                v5templateHomeUtil.getMainPageModuleInfo(schoolInfo.code, schoolInfo.template, "m01", function(err,data){return callback(err,data)});
            },//**** m01 模板头部 **** 2
            function(callback){
                v5templateHomeUtil.getSecondPageBarMenu(schoolInfo.code, function(err,data){return callback(err,data)});
            }, // ****3  m02 导航栏信息 首页导航栏请求全部的一级分类和二级分类
            function(callback){
                v5templateHomeUtil.getInfoCatByFAQ(schoolInfo.code,function(err,data){return callback(err,data)});
            ...
            //console.log(JSON.stringify(retJson));
            retJson.host = "http://"+req.hostname;
            res.render('./v5template/pages/04_subList',retJson);
        });
...
function professionalDetailPage(req,res,next){
    ...
    v5templateHomeUtil.findSchool(sCode, function(findSchoolErr, schoolInfo){
        ...
        async.series([
            ...
            function(callback) {
                // 获取专业详情信息 **** 1
                v5templateHomeUtil.majorDetail(majorId,function(err,data){callback(err,data)});
            },
            function(callback){
                v5templateHomeUtil.getMainPageModuleInfo(schoolInfo.code, schoolInfo.template, "m01", function(err,data){return callback(err,data)});
            },//**** m01 模板头部 **** 2
            ...
            retJson.host = "http://"+req.hostname;
            //console.log(JSON.stringify(retJson));
            res.render('./v5template/pages/06_professionalDetail',retJson);
        });
...
function videoOnlinePage(req,res,next){
    ...
    v5templateHomeUtil.findSchool(sCode, function(findSchoolErr, schoolInfo){
        ...
        async.series([
            function(callback) {
                // 获取二级页面 视频在线信息 **** 0
                v5templateHomeUtil.getSchoolVidoList(sCode,curPage,needPage,function(err,data){callback(err,data)});
            },
            function(callback){
                v5templateHomeUtil.getMainPageModuleInfo(schoolInfo.code, schoolInfo.template, "m01", function(err,data){return callback(err,data)});
            },//**** m01 模板头部 **** 1
            ...
            retJson.host = "http://"+req.hostname;
            res.render('./v5template/pages/07_videoOnline',retJson);
        });
...
function enrollmentPlanPage(req,res,next){
    var retJson = {};
    retJson.host = "http://"+req.hostname;
    res.render('./v5template/pages/08_enrollmentPlan',retJson);
}
...
function schoolProfilePage(req,res,next){
    ...
    superagent.get(url)
        .end(function (err, res2) {
            ...
            retJson.host = "http://"+req.hostname;
            res.render('./v5template/pages/09_schoolProfile',retJson);
...
function searchPage(req,res,next){
    ...
    v5templateHomeUtil.findSchool(sCode, function(findSchoolErr, schoolInfo){
        ...
        async.series([
            ...
            function(callback) {
                // 获取搜索列表 **** 1
                v5templateHomeUtil.findByKeyWordNew(curPage,pageSize,question,sCode,function(err,data){callback(err,data)});
            },
            function(callback){
                v5templateHomeUtil.getMainPageModuleInfo(schoolInfo.code, schoolInfo.template, "m01", function(err,data){return callback(err,data)});
            },//**** m01 模板头部 **** 2
            ...
            retJson.host = "http://"+req.hostname;
            res.render('./v5template/pages/17_searchPage',retJson);
        });
...
function photoPage(req,res,next){
    ...
    v5templateHomeUtil.findSchool(sCode, function(findSchoolErr, schoolInfo){
        ...
        async.series([
            function(callback) {
                // 获取二级页面 校园风采  相册信息 **** 0
                v5templateHomeUtil.scenery(sCode,function(err,data){callback(err,data)});
            },
            function(callback){
                v5templateHomeUtil.getMainPageModuleInfo(schoolInfo.code, schoolInfo.template, "m01", function(err,data){return callback(err,data)});
            },//**** m01 模板头部 **** 1
            ...
            retJson.host = "http://"+req.hostname;
            retJson.host = "http://"+req.hostname;
            res.render('./v5template/pages/18_photoPage',retJson);
        });
...
function facultyList(req,res,next){
    var retJson = {};
    retJson.host = "http://"+req.hostname;
    res.render('./v5template/pages/19_facultyList',retJson);
}
...
function facultyDetail(req,res,next){
    ...
    v5templateHomeUtil.findSchool(sCode, function(findSchoolErr, schoolInfo){
        ...
        async.series([
            ...
            function(callback) {
                // 获取院系详情信息 **** 1
                v5templateHomeUtil.findDepartmentDetail(departmentId,function(err,data){callback(err,data)});
            },
            function(callback){
                v5templateHomeUtil.getMainPageModuleInfo(schoolInfo.code, schoolInfo.template, "m01", function(err,data){return callback(err,data)});
            },//**** m01 模板头部 **** 2
            ...
            retJson.host = "http://"+req.hostname;
            res.render('./v5template/pages/20_facultyDetail',retJson);
        });
...
function enrollmentPlanPage(req,res,next){
    ...
    v5templateHomeUtil.findSchool(sCode, function(findSchoolErr, schoolInfo){
        ...
        async.series([
            ...
            retJson.host = "http://"+req.hostname;
            res.render('./v5template/pages/21_enrollmentPlan',retJson);
        });
...
function admissionHistoryPage(req,res,next){
    ...
    v5templateHomeUtil.findSchool(sCode, function(findSchoolErr, schoolInfo){
        ...
        async.series([
            ...
            retJson.host = "http://"+req.hostname;
            res.render('./v5template/pages/22_admissionHistory',retJson);
        });
...
function researchDirectionDetail(req,res,next){
    ...
    v5templateHomeUtil.findSchool(sCode, function(findSchoolErr, schoolInfo){
        ...
        async.series([
            ...
            function(callback){
                v5templateHomeUtil.getMajorResearchDetail(majorResearchId,function(err,data){return callback(err,data)});
            ...
            //console.log(JSON.stringify(retJson));
            retJson.host = "http://"+req.hostname;
            res.render('./v5template/pages/23_ResearchDirectionDetail',retJson);
        });
